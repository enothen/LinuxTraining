...
# LVM and partitioning and filesystems
...
# Add iso image to fstab so that it's always mounted. It's going to be used as a yum repository
/usr/sbin/blkid /dev/cdrom | awk '/CentOS/ {print $2"\t/var/www/html/pub/centos7/repo\tiso9660\t_netdev\t0 0"}' >> /etc/fstab

# Prepare the packets directory
...
#!/bin/bash
#
# These commands run once the server is installed and rebooted
#
...
# Some alias that I want to use frequently
